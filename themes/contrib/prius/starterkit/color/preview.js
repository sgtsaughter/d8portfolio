...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.color = {
    ...
    callback: function(context, settings, form, farb, height, width) {
      ...
      $('#placeholder', form).css('margin-top', '300px'); // adjusted based on Seven theme
      ...
      $('#preview #preview-page-wrapper', form).css('padding-top', drupalSettings.color.base_vmargin);
      $('#preview #preview-page-wrapper', form).css('padding-bottom', drupalSettings.color.base_vmargin);
      ...
      if (drupalSettings.color.header_bg_file) {
        if (!this.bgChanged) {
          ...
          $('#preview #preview-header', form).attr('style', 'border: none; background-image: url(' + drupalSettings.color.header_bg_file + '); background-position: ' + drupalSettings.color.header_bg_alignment + ';');
        }
      }
      else {
        // CSS3 Gradients.
        ...
        if (drupalSettings.color.layout_style == 2) {
          ...
          $('#preview #preview-header', form).css('border-width', drupalSettings.color.header_border_width);
        }
      }
